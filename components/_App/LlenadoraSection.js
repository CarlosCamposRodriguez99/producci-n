...
const LlenadoraSection = () => {
    ...
    return (
      <div className='container'>
        <h1 style={{ textAlign: 'center', marginTop: '20px', marginBottom: "20px", color: "#0880B6", textTransform: "uppercase", fontFamily: 'Montserrat, sans-serif',}}>Llenadoras</h1>
        <div>
      ...
      <div className="contenedorEnvasado">
        ...
        <div className="contenidoEnvasado">
          ...
          <p style={{
            ...
            Fabricamos una gama de máquinas llenadoras para adaptarse a una amplia variedad de líquidos, tamaños de botellas y capacidades de producción. Las características del producto determinan la máquina de llenado de botellas necesaria para sus productos. El objetivo es entregar una cantidad precisa de producto al consumidor en una botella atractiva que promueva su oferta sobre la competencia. <br></br><br></br>
            Existen varias tecnologías de llenado disponibles, y cada una funciona para un tipo específico de líquidos. <br></br><br></br>
            Si no puede encontrar una máquina adecuada, contáctenos para conocer sus requerimientos. Nuestro equipo de ingeniería está disponible para brindar soluciones de diseño de equipos personalizados.
          </p>
        </div>
      </div>
...
export default LlenadoraSection;