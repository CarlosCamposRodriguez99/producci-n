...
const HomogenizadoresSection = () => {
    ...
    return (
      <div className='container'>
        <h1 style={{ textAlign: 'center', marginTop: '20px', marginBottom: "20px", color: "#0880B6", textTransform: "uppercase", fontFamily: 'Montserrat, sans-serif',}}>Homogenizadores</h1>
        <div>
      ...
      <div className="contenedorEnvasado">
        ...
        <div className="contenidoEnvasado">
          ...
          <p style={{
            ...
            que no hay nada avergonzante escondido en el medio del texto. <br></br>
            Hay muchas variaciones de los pasajes de Lorem Ipsum disponibles, pero
            la mayoría sufrió alteraciones en alguna manera, ya sea porque se le
            agregó humor, o palabras aleatorias que no parecen ni un poco creíbles.
            Si vas a utilizar un pasaje de Lorem Ipsum, necesitás estar seguro de
    ...
    <div style={{borderBottom: "2px solid #EBEDEF", marginTop: "10px"}}></div>
...
export default HomogenizadoresSection;